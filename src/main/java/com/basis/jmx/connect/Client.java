...
public class Client {
	public static void main(String[] args) {
		try {
			...
			JMXServiceURL url = new JMXServiceURL("service:jmx:rmi://192.168.6.90:9998/jndi/rmi://192.168.6.90:9999/server");
			...
			//
			ObjectName stdMBeanName = new ObjectName(domain + ":type=com.basis.jmx.connect.SimpleStandard,name=1");
			echo("\nCreate SimpleStandard MBean...");
//			mbsc.createMBean("com.basis.jmx.connect.SimpleStandard", stdMBeanName, null, null);
			waitForEnterPressed();

			// Create SimpleDynamic MBean
			//
			ObjectName dynMBeanName = new ObjectName(domain + ":type=com.basis.jmx.connect.SimpleDynamic,name=2");
			echo("\nCreate SimpleDynamic MBean...");
			mbsc.createMBean("com.basis.jmx.connect.SimpleDynamic", dynMBeanName, null, null);
			waitForEnterPressed();
