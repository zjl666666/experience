...
import com.common.dao.impl.HibernateDaoImpl1;
 ...
 */
@Repository
public class PersonDaoHibernateImpl1 extends HibernateDaoImpl1<Person, String> implements PersonDao {
	...
	public Paging<Person> searchPersons(Paging<Person> paging) {
		Paging<Person> pageing = this.searchPersons(paging);
		return paging;
	}
