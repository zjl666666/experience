 ...
 * @param <PK>
 */
public class HibernateDaoImpl1<T, PK extends Serializable> extends SimpleHibernateDaoImpl1<T, PK> {
	 ...
	 */
	public HibernateDaoImpl1(SessionFactory sessionFactory, Class<T> entityClass) {
