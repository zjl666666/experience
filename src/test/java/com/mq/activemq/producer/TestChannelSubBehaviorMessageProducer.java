...
public class TestChannelSubBehaviorMessageProducer {
	
	@Resource(name = "channelSubBehaviorMessageProducer")
	private ChannelSubBehaviorMessageProducer channelSubBehaviorMessageProducer;
